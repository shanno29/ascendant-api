const items = [
  {
    ...
    nav: 'licensing',
    title: 'Licensing',
    image: 'http://s.tvurl.co/img/get/6ce15d69-fbea-498d-9e92-a7a900b0c410/stock-photo-h-n-medicine-doctor-working-with-computer-interface-as-medical-476187187_275.jpg',
    texts: [
      ...
      'We take pride in our ability to get your application done fast, effectively and correct. If you’re thinking about expanding your business into other states, opening up a pharmacy, enrolling into Medicaid/Medicare or just have questions about pharmacy, call us.',
  ...
  },
  {
    ...
    image: 'http://s.tvurl.co/img/get/b6ab6a3d-b682-4433-8eaa-a7a100ec05c2/images.jpg',
    texts: [
  ...
  },
  {
    ...
    image: 'http://s.tvurl.co/img/get/61cda444-78c2-4f85-bdb9-a7a90084eeae/istock_000063297325_medium275h183.jpg',
    texts: [
  ...
  {
    id: 4,
    nav: 'buy-sell-pharmacies',
    title: 'Buy / Sell Pharmacies',
    image: 'http://s.tvurl.co/img/get/24ba415d-bc62-4376-8af3-a7af00b5dffa/stock-photo-doctor-writing-on-medical-health-care-record-patients-discharge-or-prescription-form-paperwork-in-606094208_275.jpg',
    texts: [
  ...
  {
    id: 5,
    nav: 'non-resident-licensing',
    title: 'Non-Resident Licensing',
    image: 'http://s.tvurl.co/img/get/e1a1cd9d-12de-47ef-ae64-a7af00bd554f/stock-photo-the-pharmacist-gives-advice-on-medicaments-at-the-pharmacy-534434407_275.jpg',
    texts: [
  ...
  {
    id: 6,
    nav: 'inspection-preparations',
    title: 'Inspection Preparations',
    image: 'http://s.tvurl.co/img/get/e06d8660-596e-4331-9a6c-a7a9009655ad/stock-photo-female-and-male-pharmacists-in-pharmacy-418744852_275.jpg',
    texts: [
  ...
  },
  {
    ...
    image: 'http://s.tvurl.co/img/get/28c659d5-f479-48d3-836f-a7a9009ad908/stock-photo-pharmacist-in-drugstore-419242378_275.jpg',
    texts: [
  ...
  {
    id: 8,
    nav: 'medicaid-medicare-applications',
    title: 'Medicaid / Medicare Applications',
    image: 'http://s.tvurl.co/img/get/4d98850a-0ac1-469e-855a-a7af00bd302c/stock-photo-rx-health-care-concept-icon-medicine-healthcare-concept-doctor-presses-rx-button-drug-522399988_275.jpg',
    texts: [
...
module.exports = {
  ...
  getAllConsultingSections: () => new Promise(resolve => resolve(items)),

  consultingSectionBy: name => new Promise(it => it(items.filter(item => item.nav === name)[0])),
